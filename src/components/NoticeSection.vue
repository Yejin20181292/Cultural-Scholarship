    ...
    <div class="container">
      <div class="section-header reveal" ref="headerRef">
        ...
        <p class="section-description">
          문화장학재단의 최신 공지사항과 활동 소식, 장학생들의 빛나는 창작 이야기를 전해드립니다.
        </p>
      </div>
...
const notices = [
  ...
  },
  {
    ...
    type: 'normal',
    tagText: '안내',
    title: '2026 문화장학재단 학술 세미나 참가자 모집 안내',
    date: '2026.07.08'
  },
  {
    id: 4,
...
const news = [
  ...
  },
  {
    ...
    summary: '재단으로부터 3년간 전통문화 계승 장학금을 수여 받은 이지윤(가야금 병창 전공) 학생이 문화재청 주관 심사를 통해 역대 최연소 무형문화재 이수자로 선정되었습니다.',
